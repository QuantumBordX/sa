...
var listener = app.listen(process.env.PORT, function() {
  console.log('Beta Bot Başlatılıyor. Port: ' + listener.address().port);
});
...
client.ayarlar = {
  "token": "OTQwNzQyNjkwNjI5MzY5ODY3.YgL05w.sovWkqO0B8-qVoxvm_0uAiSt51A", //Buraya botunuzun https://discordapp.com/developers/applications sitesindeki tokenini yazınız
  "sahip": "679251149873741825",//Buraya bot sahibinin IDini giriniz
  ...
  "yardimcilar": ["B412 Community"], //Buradaki "" lara botunuzu yaparken size yardım edenleri yazınız
...
client.on("ready", async () => {
  console.log(`Developed By Ђ*JBW | QbordX#2505`)
  client.user.setActivity(`Quantum<3`)
